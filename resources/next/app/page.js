            ...
            <div className="row g-4 align-items-center">
              <div className="col-lg-6">
                <div className="business-boost-content">
                  ...
                  <p className="wow fadeInUp" data-wow-delay=".6s">
                  We’re selective about who joins our community to ensure a supportive and motivated environment. <br />
                  Take the first step by completing our brief questionnaire. If you’re a good fit, we’ll extend a personal invitation to join us.
                  </p>
                  <Link
                    href="contact"
